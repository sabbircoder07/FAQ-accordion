...
var _accordionView = require("./view/accordionView");
var _accordionViewDefault = parcelHelpers.interopDefault(_accordionView);

},{"./view/accordionView":"nUSgO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"nUSgO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconPlusSvg = require("url:../../images/icon-plus.svg");
var _iconPlusSvgDefault = parcelHelpers.interopDefault(_iconPlusSvg);
var _iconMinusSvg = require("url:../../images/icon-minus.svg");
...
class accordinView {
    ...
    accordinShowHide(event) {
        try {
            ...
            const accordinDetailsActive = event.target.closest(".accordin-container").querySelector(".accordin-details");
    ...
    _addHandlerAccordionHeaderClick() {
        this._parentElement.addEventListener("click", this.accordinShowHide.bind(this));
    }
}
exports.default = new accordinView();

},{"url:../../images/icon-plus.svg":"c3ujg","url:../../images/icon-minus.svg":"fBw8S","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c3ujg":[function(require,module,exports) {
module.exports = require("8eaf1fb83705aefc").getBundleURL("7tDcp") + "icon-plus.52b4df89.svg" + "?" + Date.now();

},{"8eaf1fb83705aefc":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"fBw8S":[function(require,module,exports) {
module.exports = require("3bb73e3a9a1ae6c0").getBundleURL("7tDcp") + "icon-minus.d4c224cf.svg" + "?" + Date.now();

},{"3bb73e3a9a1ae6c0":"lgJ39"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["klTFg","2dUup"], "2dUup", "parcelRequire5e9d")
