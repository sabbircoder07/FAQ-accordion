...
})({"cgkzZ":[function(require,module,exports) {
...
faqContainer.addEventListener("click", function(event) {
    try {
        ...
        accordinHeaderImg.forEach((img)=>img.src = (0, _iconPlusSvgDefault.default));
        ...
        accordinContainer.forEach((accordin)=>accordin.classList.remove("active"));
...
},{"../../assets/images/icon-plus.svg":"6jQMm","../../assets/images/icon-minus.svg":"f7ouZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6jQMm":[function(require,module,exports) {
module.exports = require("a6f48407d0dfd7d7").getBundleURL("fh2Ay") + "icon-plus.5392e01d.svg" + "?" + Date.now();

},{"a6f48407d0dfd7d7":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"f7ouZ":[function(require,module,exports) {
module.exports = require("24f75db600852cb7").getBundleURL("fh2Ay") + "icon-minus.26b711cc.svg" + "?" + Date.now();

},{"24f75db600852cb7":"lgJ39"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["cgkzZ","biPfD"], "biPfD", "parcelRequire5e9d")
